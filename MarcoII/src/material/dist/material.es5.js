import { ChangeDetectorRef, ContentChild, ContentChildren, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Injectable, Input, NgModule, Optional, Output, Renderer2, Self, SimpleChange, SkipSelf, forwardRef } from '@angular/core';
...
import { MDCSimpleMenu, MDCSimpleMenuFoundation, util as util$1 } from '@material/menu';
...
import { MDCTabBarFoundation, MDCTabBarScrollerFoundation, MDCTabFoundation } from '@material/tabs';
import { NavigationEnd, Router, RouterLink, RouterLinkWithHref } from '@angular/router';
import { MDCTextFieldFoundation } from '@material/textfield';
import { MDCToolbarFoundation, util as util$2 } from '@material/toolbar';
...
var matchesProperty = (util.getMatchesProperty(HTMLElement.prototype));
/**
 * \@docs-private
 * @abstract
 */
    ...
    function AbstractMdcRipple(_rippleElm, _renderer, _registry) {
        ...
        this.mdcRippleAdapter = {
            ...
            registerInteractionHandler: function (type, handler) {
                ...
                _this._registry.listenElm(_this._renderer, type, handler, target, util.applyPassive());
            },
...
var MdcButtonDirective = (function (_super) {
    ...
    MdcButtonDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcRipple, useExisting: forwardRef(function () { return MdcButtonDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
    ...
    MdcButtonDirective.propDecorators = {
        ...
        'stroked': [{ type: HostBinding, args: ['class.mdc-button--stroked',] }, { type: Input },],
        'compact': [{ type: HostBinding, args: ['class.mdc-button--compact',] }, { type: Input },],
        'dense': [{ type: HostBinding, args: ['class.mdc-button--dense',] }, { type: Input },],
    };
...
var MdcCardPrimaryDirective = (function () {
    ...
    MdcCardPrimaryDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-card__primary',] },],
    };
...
var MdcCardTitleDirective = (function () {
    ...
    MdcCardTitleDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-card__title',] },],
        'large': [{ type: HostBinding, args: ['class.mdc-card__title--large',] }, { type: Input },],
    };
...
var MdcCardSubtitleDirective = (function () {
    ...
    MdcCardSubtitleDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-card__subtitle',] },],
    };
...
var MdcCardTextDirective = (function () {
    ...
    MdcCardTextDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-card__supporting-text',] },],
    };
...
var MdcCardActionsDirective = (function () {
    ...
    MdcCardActionsDirective.propDecorators = {
        ...
        '_children': [{ type: ContentChildren, args: [MdcButtonDirective, { descendants: false },] },],
        'compact': [{ type: Input },],
        'vertical': [{ type: HostBinding, args: ['class.mdc-card__actions--vertical',] }, { type: Input },],
    };
...
var MdcCardHorizontalDirective = (function () {
    ...
    MdcCardHorizontalDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-card__horizontal-block',] },],
    };
...
var MdcCardMediaItemDirective = (function () {
    ...
    MdcCardMediaItemDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-card__media-item',] },],
        '_size1dot5': [{ type: HostBinding, args: ['class.mdc-card__media-item--1dot5x',] },],
        '_size2': [{ type: HostBinding, args: ['class.mdc-card__media-item--2x',] },],
        '_size3': [{ type: HostBinding, args: ['class.mdc-card__media-item--3x',] },],
        'sizeFactor': [{ type: Input },],
    };
...
var MdcCheckboxInputDirective = (function (_super) {
    ...
    MdcCheckboxInputDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcInput, useExisting: forwardRef(function () { return MdcCheckboxInputDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcCheckboxDirective = (function (_super) {
    __extends(MdcCheckboxDirective, _super);
    /**
     * @param {?} renderer
     * @param {?} root
     * @param {?} registry
    ...
    function MdcCheckboxDirective(renderer, root, registry) {
        ...
        _this.foundation = new MDCCheckboxFoundation(_this.mdcAdapter);
        return _this;
    }
    /**
     * @return {?}
    ...
    MdcCheckboxDirective.propDecorators = {
        ...
        '_input': [{ type: ContentChild, args: [MdcCheckboxInputDirective,] },],
        '_disabled': [{ type: HostBinding, args: ['class.mdc-checkbox--disabled',] },],
    };
...
var MdcFabIconDirective = (function () {
    ...
    MdcFabIconDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-fab__icon',] },],
    };
...
var MdcFabDirective = (function (_super) {
    __extends(MdcFabDirective, _super);
    /**
     * @param {?} _elm
     * @param {?} renderer
     * @param {?} registry
    ...
    MdcFabDirective.decorators = [
        { type: Directive, args: [{
                    selector: '[mdcFab]',
                    providers: [{ provide: AbstractMdcRipple, useExisting: forwardRef(function () { return MdcFabDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
    ...
    MdcFabDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-fab',] },],
        'mini': [{ type: HostBinding, args: ['class.mdc-fab--mini',] }, { type: Input },],
        'exited': [{ type: HostBinding, args: ['class.mdc-fab--exited',] }, { type: Input },],
    };
...
var MdcFormFieldInputDirective = (function (_super) {
    __extends(MdcFormFieldInputDirective, _super);
    /**
     * @param {?} _elm
     * @param {?} _cntr
     */
    ...
    MdcFormFieldInputDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcInput, useExisting: forwardRef(function () { return MdcFormFieldInputDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcFormFieldLabelDirective = (function (_super) {
    __extends(MdcFormFieldLabelDirective, _super);
    /**
     * @param {?} _elm
     */
    ...
    MdcFormFieldLabelDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcLabel, useExisting: forwardRef(function () { return MdcFormFieldLabelDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcIconToggleDirective = (function (_super) {
    __extends(MdcIconToggleDirective, _super);
    /**
     * @param {?} elm
     * @param {?} renderer
     * @param {?} registry
    ...
    function MdcIconToggleDirective(elm, renderer, registry) {
        ...
        the icon).
         */
        _this.isOnChange = new EventEmitter();
        ...
        _this.foundation = new MDCIconToggleFoundation(_this.mdcAdapter);
        return _this;
    }
    /**
     * @return {?}
    ...
    MdcIconToggleDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-icon-toggle',] },],
        '_role': [{ type: HostBinding, args: ['attr.role',] },],
        '_innerIcon': [{ type: ContentChild, args: [MdcIconToggleIconDirective, { read: ElementRef },] },],
        'isOnChange': [{ type: Output },],
        'isOn': [{ type: Input },],
        'labelOn': [{ type: Input },],
        'labelOff': [{ type: Input },],
        'iconOn': [{ type: Input },],
        'iconOff': [{ type: Input },],
        'iconIsClass': [{ type: Input },],
        'disabled': [{ type: Input },],
...
var MdcFormsIconToggleDirective = (function () {
    ...
    MdcFormsIconToggleDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [
                        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return MdcFormsIconToggleDirective; }), multi: true }
                    ]
                },] },
    ];
    /**
...
var MdcLinearProgressDirective = (function () {
    ...
    MdcLinearProgressDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-linear-progress',] },],
        '_role': [{ type: HostBinding, args: ['attr.role',] },],
        '_indeterminate': [{ type: HostBinding, args: ['class.' + CLASS_INDETERMINATE,] },],
        '_reverse': [{ type: HostBinding, args: ['class.' + CLASS_REVERSED,] },],
        'isIndeterminate': [{ type: Input }, { type: HostBinding, args: ['class.' + CLASS_INDETERMINATE,] },],
        'isReversed': [{ type: Input }, { type: HostBinding, args: ['class.' + CLASS_REVERSED,] },],
...
var MdcListDividerDirective = (function () {
    ...
    MdcListDividerDirective.propDecorators = {
        ...
        'hasInset': [{ type: Input }, { type: HostBinding, args: ['class.mdc-list-divider--inset',] },],
    };
...
var MdcListItemTextSecondaryDirective = (function () {
    ...
    MdcListItemTextSecondaryDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-list-item__text__secondary',] },],
    };
...
var MdcListItemStartDetailDirective = (function () {
    ...
    MdcListItemStartDetailDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-list-item__start-detail',] },],
    };
...
var MdcListItemEndDetailDirective = (function () {
    ...
    MdcListItemEndDetailDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-list-item__end-detail',] },],
    };
...
var MdcListDirective = (function () {
    ...
    MdcListDirective.propDecorators = {
        ...
        '_texts': [{ type: ContentChildren, args: [MdcListItemTextDirective, { descendants: true },] },],
        '_twoLine': [{ type: HostBinding, args: ['class.mdc-list--two-line',] },],
        '_role': [{ type: HostBinding, args: ['attr.role',] },],
        '_ariaHidden': [{ type: HostBinding, args: ['attr.aria-hidden',] },],
        '_isMenu': [{ type: HostBinding, args: ['class.mdc-simple-menu__items',] },],
...
var MdcMenuAnchorDirective = (function () {
    ...
    MdcMenuAnchorDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-menu-anchor',] },],
    };
...
var MdcSimpleMenuDirective = (function () {
    ...
    function MdcSimpleMenuDirective(_elm, _rndr, _registry) {
        ...
        this.mdcAdapter = {
            ...
            setScale: function (x, y) {
                _this._elm.nativeElement.style[util$1.getTransformPropertyName(window)] = "scale(" + x + ", " + y + ")";
            },
            setInnerScale: function (x, y) {
                _this._list._elm.nativeElement.style[util$1.getTransformPropertyName(window)] = "scale(" + x + ", " + y + ")";
            },
            ...
            setTransformOrigin: function (origin) {
                _this._elm.nativeElement.style[util$1.getTransformPropertyName(window) + "-origin"] = origin;
            },
            ...
            if (_this._lastList !== _this._listQuery.first) {
                ...
                if (_this._lastList) {
                    ...
                    if (_this._component == null)
                        _this._component = new MDCSimpleMenu(_this._elm.nativeElement, _this.foundation);
                }
                else {
                    _this._component.destroy();
                    _this._component = null;
                    _this.foundation = new MDCSimpleMenuFoundation(_this.mdcAdapter);
                }
            }
        });
        if (this._lastList)
    ...
    MdcSimpleMenuDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-simple-menu',] },],
        'menuAnchor': [{ type: Input },],
        'pick': [{ type: Output },],
        'cancel': [{ type: Output },],
        'isOpenChange': [{ type: Output },],
        '_listQuery': [{ type: ContentChildren, args: [MdcListDirective,] },],
        '_isSelect': [{ type: HostBinding, args: ['class.mdc-select__menu',] },],
        'isOpen': [{ type: Input }, { type: HostBinding, args: ['class.mdc-simple-menu--open',] },],
        'openFrom': [{ type: Input },],
        '_tl': [{ type: HostBinding, args: ['class.mdc-simple-menu--open-from-top-left',] },],
        '_tr': [{ type: HostBinding, args: ['class.mdc-simple-menu--open-from-top-right',] },],
        '_bl': [{ type: HostBinding, args: ['class.mdc-simple-menu--open-from-bottom-left',] },],
        '_br': [{ type: HostBinding, args: ['class.mdc-simple-menu--open-from-bottom-right',] },],
        'viewport': [{ type: Input },],
    };
...
var MdcRadioInputDirective = (function (_super) {
    __extends(MdcRadioInputDirective, _super);
    /**
     * @param {?} _elm
     * @param {?} _cntr
     */
    ...
    MdcRadioInputDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcInput, useExisting: forwardRef(function () { return MdcRadioInputDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcRadioDirective = (function (_super) {
    __extends(MdcRadioDirective, _super);
    /**
     * @param {?} renderer
     * @param {?} root
     * @param {?} registry
    ...
    function MdcRadioDirective(renderer, root, registry) {
        ...
        _this.foundation = new MDCRadioFoundation(_this.mdcAdapter);
        return _this;
    }
    /**
     * @return {?}
    ...
    MdcRadioDirective.propDecorators = {
        ...
        '_input': [{ type: ContentChild, args: [MdcRadioInputDirective,] },],
...
var MdcRippleDirective = (function (_super) {
    ...
    MdcRippleDirective.propDecorators = {
        '_on': [{ type: HostBinding, args: ['class.mdc-ripple-surface',] },],
...
var MdcSelectTextDirective = (function () {
    ...
    MdcSelectTextDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.' + CLASS_SELECT_SELECTED_TEXT,] },],
    };
...
var MdcSelectDirective = (function () {
    ...
    function MdcSelectDirective(_elm, _rndr, _registry) {
        ...
        this.foundation = new MDCSelectFoundation(this.mdcAdapter);
    }
    /**
     * @return {?}
     */
    MdcSelectDirective.prototype.ngAfterContentInit = function () {
        ...
        this._menu._list._items.changes.pipe(takeUntil$1(this.onDestroy$)).subscribe(function () {
    ...
    MdcSelectDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.' + CLASS_SELECT,] },],
        '_role': [{ type: HostBinding, args: ['attr.role',] },],
        '_menu': [{ type: ContentChild, args: [MdcSimpleMenuDirective,] },],
        '_text': [{ type: ContentChild, args: [MdcSelectTextDirective,] },],
...
var MdcFormsSelectDirective = (function () {
    ...
    MdcFormsSelectDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [
                        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return MdcFormsSelectDirective; }), multi: true }
                    ]
                },] },
    ];
    /**
...
var MdcSelectMultipleNativeDirective = (function () {
    ...
    MdcSelectMultipleNativeDirective.propDecorators = {
        '_cls1': [{ type: HostBinding, args: ['class.mdc-multi-select',] },],
        '_cls2': [{ type: HostBinding, args: ['class.mdc-list',] },],
        'options': [{ type: ContentChildren, args: [MdcSelectOptionNativeDirective, { descendants: true },] },],
        'groups': [{ type: ContentChildren, args: [MdcSelectGroupNativeDirective, { descendants: true },] },],
    };
...
var MdcSliderDirective = (function () {
    ...
    MdcSliderDirective.propDecorators = {
        ...
        'isDiscrete': [{ type: Input }, { type: HostBinding, args: ['class.mdc-slider--discrete',] },],
        'hasMarkers': [{ type: Input }, { type: HostBinding, args: ['class.mdc-slider--display-markers',] },],
...
var MdcFormsSliderDirective = (function () {
    ...
    MdcFormsSliderDirective.prototype.writeValue = function (obj) {
        var /** @type {?} */ change = new SimpleChange(this.mdcSlider.value, +obj, false);
    ...
    MdcFormsSliderDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [
                        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return MdcFormsSliderDirective; }), multi: true }
                    ]
                },] },
    ];
    /**
...
var MdcSnackbarService = (function () {
    function MdcSnackbarService() {
        ...
        this.closeMessage = new Subject$1();
    }
    /**
     * @return {?}
     */
    ...
    MdcSnackbarService.prototype.getFoundation = function (root) {
        ...
        var /** @type {?} */ adapter = {
            ...
            registerTransitionEndHandler: function (handler) { return root.addEventListener(getCorrectEventName(window, 'transitionend'), handler); },
            deregisterTransitionEndHandler: function (handler) { return root.removeEventListener(getCorrectEventName(window, 'transitionend'), handler); }
        };
    ...
    MdcSnackbarService.prototype.show = function (message) {
        ...
        this.closeMessage.asObservable().pipe(filter$1(function (nr) { return nr === messageNr; }), take$1(1)).subscribe(function (nr) {
            action.complete();
        });
...
var MdcSwitchInputDirective = (function (_super) {
    __extends(MdcSwitchInputDirective, _super);
    /**
     * @param {?} _elm
     * @param {?} _cntr
     */
    ...
    MdcSwitchInputDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcInput, useExisting: forwardRef(function () { return MdcSwitchInputDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcSwitchDirective = (function () {
    ...
    MdcSwitchDirective.propDecorators = {
        ...
        '_input': [{ type: ContentChild, args: [MdcSwitchInputDirective,] },],
        '_disabled': [{ type: HostBinding, args: ['class.mdc-switch--disabled',] },],
    };
...
var MdcTabIconDirective = (function () {
    ...
    MdcTabIconDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-tab__icon',] },],
    };
...
var MdcTabIconTextDirective = (function () {
    ...
    MdcTabIconTextDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-tab__icon-text',] },],
    };
    return MdcTabIconTextDirective;
}());
var AbstractMdcTabDirective = (function (_super) {
    __extends(AbstractMdcTabDirective, _super);
    /**
     * @param {?} _rndr
     * @param {?} _root
     * @param {?} _registry
    ...
    function AbstractMdcTabDirective(_rndr, _root, _registry) {
        ...
        _this._foundation = new MDCTabFoundation(_this._adapter);
        return _this;
    }
    /**
     * @return {?}
    ...
    AbstractMdcTabDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-tab',] },],
        '_mdcTabIcon': [{ type: ContentChild, args: [MdcTabIconDirective,] },],
        '_mdcTabIconText': [{ type: ContentChild, args: [MdcTabIconTextDirective,] },],
        'activate': [{ type: Output },],
        '_tabWithIconAndText': [{ type: HostBinding, args: ['class.mdc-tab--with-icon-and-text',] },],
        '_active': [{ type: HostBinding, args: ['class.mdc-tab--active',] },],
    };
    return AbstractMdcTabDirective;
}(AbstractMdcRipple));
var MdcTabDirective = (function (_super) {
    __extends(MdcTabDirective, _super);
    /**
     * @param {?} rndr
     * @param {?} root
     * @param {?} registry
    ...
    MdcTabDirective.decorators = [
        { type: Directive, args: [{
                    selector: '[mdcTab]',
                    providers: [{ provide: AbstractMdcTabDirective, useExisting: forwardRef(function () { return MdcTabDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcTabRouterDirective = (function (_super) {
    __extends(MdcTabRouterDirective, _super);
    /**
     * @param {?} rndr
     * @param {?} root
     * @param {?} registry
    ...
    function MdcTabRouterDirective(rndr, root, registry, router$$1, cdr) {
        ...
        _this.cdr = cdr;
        _this.onDestroy$ = new Subject$1();
        router$$1.events.pipe(takeUntil$1(_this.onDestroy$)).subscribe(function (s) {
    ...
    MdcTabRouterDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcTabDirective, useExisting: forwardRef(function () { return MdcTabRouterDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
...
var MdcTabBarDirective = (function () {
    ...
    MdcTabBarDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.' + CLASS_TAB_BAR,] },],
        '_insideScrollFrame': [{ type: HostBinding, args: ['class.mdc-tab-bar-scroller__scroll-frame__tabs',] },],
        '_tabs': [{ type: ContentChildren, args: [AbstractMdcTabDirective, { descendants: false },] },],
        'tabChange': [{ type: Output },],
        '_tabBarWithIcon': [{ type: HostBinding, args: ['class.' + CLASS_ICONS_BAR,] },],
        '_tabBarWithIconAndText': [{ type: HostBinding, args: ['class.' + CLASS_ICONS_WITH_TEXT_BAR,] },],
    };
...
var MdcTabBarScrollerInnerDirective = (function () {
    ...
    MdcTabBarScrollerInnerDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.' + CLASS_INDICATOR_INNER,] },],
    };
...
var MdcTabBarScrollerBackDirective = (function () {
    ...
    MdcTabBarScrollerBackDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.' + CLASS_INDICATOR$1,] },],
        '_back': [{ type: HostBinding, args: ['class.' + CLASS_INDICATOR_BACK,] },],
    };
...
var MdcTabBarScrollerForwardDirective = (function () {
    ...
    MdcTabBarScrollerForwardDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.' + CLASS_INDICATOR$1,] },],
        '_forward': [{ type: HostBinding, args: ['class.' + CLASS_INDICATOR_FORWARD,] },],
    };
...
var MdcTabBarScrollerFrameDirective = (function () {
    ...
    MdcTabBarScrollerFrameDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.' + CLASS_SCROLLER_FRAME,] },],
        '_tabBar': [{ type: ContentChild, args: [MdcTabBarDirective,] },],
    };
...
var MdcTabBarScrollerDirective = (function () {
    ...
    function MdcTabBarScrollerDirective(_rndr, _el, registry) {
        ...
        this._adapter = {
            ...
            setTransformStyleForTabBar: function (value) {
                if (_this._scrollFrame && _this._scrollFrame._tabBar)
                    _this._rndr.setStyle(_this._scrollFrame._tabBar._el.nativeElement, getCorrectPropertyName(window, 'transform'), value);
            },
        ...
        this._foundation = new MDCTabBarScrollerFoundation(this._adapter);
    }
    /**
     * @return {?}
     */
    ...
    MdcTabBarScrollerDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.' + CLASS_SCROLLER,] },],
        '_back': [{ type: ContentChild, args: [MdcTabBarScrollerBackDirective,] },],
        '_forward': [{ type: ContentChild, args: [MdcTabBarScrollerForwardDirective,] },],
        '_scrollFrame': [{ type: ContentChild, args: [MdcTabBarScrollerFrameDirective,] },],
...
var MdcTextFieldInputDirective = (function (_super) {
    __extends(MdcTextFieldInputDirective, _super);
    /**
     * @param {?} _elm
     * @param {?} renderer
     * @param {?} _cntr
    ...
    MdcTextFieldInputDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcInput, useExisting: forwardRef(function () { return MdcTextFieldInputDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
    ...
    MdcTextFieldInputDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-text-field__input',] },],
        'id': [{ type: HostBinding }, { type: Input },],
        'disabled': [{ type: HostBinding }, { type: Input },],
...
var MdcTextFieldLabelDirective = (function (_super) {
    __extends(MdcTextFieldLabelDirective, _super);
    /**
     * @param {?} _elm
     */
    ...
    MdcTextFieldLabelDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcLabel, useExisting: forwardRef(function () { return MdcTextFieldLabelDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
    ...
    MdcTextFieldLabelDirective.propDecorators = {
        'for': [{ type: HostBinding },],
        '_cls': [{ type: HostBinding, args: ['class.mdc-text-field__label',] },],
    };
...
var MdcTextFieldHelptextDirective = (function () {
    ...
    MdcTextFieldHelptextDirective.propDecorators = {
        '_cls': [{ type: HostBinding, args: ['class.mdc-text-field-helptext',] },],
        '_isValidation': [{ type: HostBinding, args: ['class.mdc-text-field-helptext--validation-msg',] },],
        '_isPersistent': [{ type: HostBinding, args: ['class.mdc-text-field-helptext--persistent',] },],
        'forceShow': [{ type: Input },],
        'isValidation': [{ type: Input },],
        'isPersistent': [{ type: Input },],
    };
    return MdcTextFieldHelptextDirective;
}());
var MdcTextFieldDirective = (function (_super) {
    __extends(MdcTextFieldDirective, _super);
    /**
     * @param {?} renderer
     * @param {?} root
     * @param {?} registry
    ...
    function MdcTextFieldDirective(renderer, root, registry) {
        ...
        _this.foundation = new MDCTextFieldFoundation(_this.mdcAdapter);
        return _this;
    }
    /**
     * @return {?}
    ...
    MdcTextFieldDirective.decorators = [
        { type: Directive, args: [{
                    ...
                    providers: [{ provide: AbstractMdcRipple, useExisting: forwardRef(function () { return MdcTextFieldDirective; }) }]
                },] },
    ];
    /**
     * @nocollapse
    ...
    MdcTextFieldDirective.propDecorators = {
        ...
        '_icon': [{ type: ContentChild, args: [MdcTextFieldIconDirective,] },],
        '_input': [{ type: ContentChild, args: [MdcTextFieldInputDirective,] },],
        '_label': [{ type: ContentChild, args: [MdcTextFieldLabelDirective,] },],
        '_labels': [{ type: ContentChildren, args: ['label', { descendants: true, read: ElementRef },] },],
        'helptext': [{ type: Input },],
        'isValid': [{ type: Input },],
        '_textArea': [{ type: HostBinding, args: ['class.mdc-text-field--textarea',] },],
        'boxed': [{ type: HostBinding, args: ['class.mdc-text-field--box',] }, { type: Input },],
        '_leadingIcon': [{ type: HostBinding, args: ['class.mdc-text-field--with-leading-icon',] },],
        '_trailingIcon': [{ type: HostBinding, args: ['class.mdc-text-field--with-trailing-icon',] },],
        'dense': [{ type: HostBinding, args: ['class.mdc-text-field--dense',] }, { type: Input },],
    };
...
var MdcToolbarRowDirective = (function () {
    ...
    MdcToolbarRowDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar__row',] },],
    };
...
var MdcToolbarSectionDirective = (function () {
    ...
    MdcToolbarSectionDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar__section',] },],
        'alignStart': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar__section--align-start',] },],
        'alignEnd': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar__section--align-end',] },],
        'shrinkToFit': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar__section--shrink-to-fit',] },],
    };
...
var MdcToolbarTitleDirective = (function () {
    ...
    MdcToolbarTitleDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar__title',] },],
    };
...
var MdcToolbarIcon = (function () {
    ...
    MdcToolbarIcon.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar__icon',] },],
    };
...
var MdcToolbarMenuIcon = (function () {
    ...
    MdcToolbarMenuIcon.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar__menu-icon',] },],
    };
...
var MdcToolbarFixedAdjustDirective = (function () {
    ...
    MdcToolbarFixedAdjustDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar-fixed-adjust',] },],
    };
...
var MdcToolbarDirective = (function () {
    ...
    function MdcToolbarDirective(renderer, root, registry) {
         ...
         */
        this.expansionRatio = new EventEmitter();
        this._initialized = false;
        this._fixed = false;
        ...
        this.mdcAdapter = {
            ...
            registerScrollHandler: function (handler) {
                if (_this._viewport)
                    _this._viewport.addEventListener('scroll', handler, util$2.applyPassive());
                else
                    window.addEventListener('scroll', handler, util$2.applyPassive());
            },
            deregisterScrollHandler: function (handler) {
                if (_this._viewport)
                    _this._viewport.removeEventListener('scroll', handler, util$2.applyPassive());
                else
                    window.removeEventListener('scroll', handler, util$2.applyPassive());
            },
            registerResizeHandler: function (handler) {
                window.addEventListener('resize', handler, util$2.applyPassive());
            },
            deregisterResizeHandler: function (handler) {
                window.removeEventListener('resize', handler, util$2.applyPassive());
            },
        ...
        this.foundation = new MDCToolbarFoundation(this.mdcAdapter);
    }
    /**
     * @return {?}
     */
    MdcToolbarDirective.prototype.ngAfterViewInit = function () {
        ...
        if (this._viewport) {
            ...
            this._viewport.addEventListener('scroll', this._mdcViewPortScrollListener, util$2.applyPassive());
        }
    ...
    MdcToolbarDirective.prototype.ngOnDestroy = function () {
        if (this._mdcViewPortScrollListener)
            this._viewport.removeEventListener('scroll', this._mdcViewPortScrollListener, util$2.applyPassive());
        this.foundation.destroy();
    };
    /**
     * @return {?}
    ...
    MdcToolbarDirective.propDecorators = {
        '_hostClass': [{ type: HostBinding, args: ['class.mdc-toolbar',] },],
        'fixedAdjust': [{ type: Input },],
        'expansionRatio': [{ type: Output },],
        '_title': [{ type: ContentChild, args: [MdcToolbarTitleDirective,] },],
        '_firstRow': [{ type: ContentChild, args: [MdcToolbarRowDirective,] },],
        '_updateViewPort': [{ type: HostListener, args: ['window:resize', ['$event'],] },],
        'isFixed': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar--fixed',] },],
        'isWaterfall': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar--waterfall',] },],
        'isFixedLastrowOnly': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar--fixed-lastrow-only',] },],
        'isFlexible': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar--flexible',] },],
        'isFlexibleDefaultBehavior': [{ type: Input }, { type: HostBinding, args: ['class.mdc-toolbar--flexible-default-behavior',] },],
        'viewport': [{ type: Input },],
    };
...
export { MdcButtonDirective, MdcCardDirective, MdcCardHorizontalDirective, MdcCardPrimaryDirective, MdcCardTitleDirective, MdcCardSubtitleDirective, MdcCardTextDirective, MdcCardMediaDirective, MdcCardMediaItemDirective, MdcCardActionsDirective, MdcCheckboxDirective, MdcCheckboxInputDirective, MdcElevationDirective, MdcFabDirective, MdcFabIconDirective, MdcFormFieldDirective, MdcFormFieldInputDirective, MdcFormFieldLabelDirective, MdcIconToggleDirective, MdcIconToggleIconDirective, MdcFormsIconToggleDirective, MdcLinearProgressDirective, MdcListDividerDirective, MdcListItemDirective, MdcListItemTextDirective, MdcListItemTextSecondaryDirective, MdcListItemStartDetailDirective, MdcListItemEndDetailDirective, MdcListDirective, MdcListGroupSubHeaderDirective, MdcListGroupDirective, MdcMenuAnchorDirective, MdcSimpleMenuDirective, MdcRadioDirective, MdcRadioInputDirective, MdcRippleDirective, MdcSelectDirective, MdcSelectTextDirective, MdcFormsSelectDirective, MdcSelectNativeDirective, MdcSelectMultipleNativeDirective, MdcSelectGroupNativeDirective, MdcSelectOptionNativeDirective, MdcSliderDirective, MdcFormsSliderDirective, MdcSnackbarService, MdcSwitchInputDirective, MdcSwitchDirective, AbstractMdcTabDirective, MdcTabDirective, MdcTabIconDirective, MdcTabIconTextDirective, MdcTabRouterDirective, MdcTabBarDirective, MdcTabBarScrollerDirective, MdcTabBarScrollerInnerDirective, MdcTabBarScrollerBackDirective, MdcTabBarScrollerForwardDirective, MdcTabBarScrollerFrameDirective, MdcTextFieldDirective, MdcTextFieldInputDirective, MdcTextFieldIconDirective, MdcTextFieldLabelDirective, MdcTextFieldHelptextDirective, MdcToolbarDirective, MdcToolbarRowDirective, MdcToolbarSectionDirective, MdcToolbarTitleDirective, MdcToolbarIcon, MdcToolbarMenuIcon, MdcToolbarFixedAdjustDirective, MdcScrollbarResizeDirective, MdcEventRegistry, MaterialModule, AbstractMdcInput as ɵf, AbstractMdcLabel as ɵg, AbstractMdcRipple as ɵe, MDC_SNACKBAR_PROVIDER as ɵb, MDC_SNACKBAR_PROVIDER_FACTORY as ɵa, MDC_EVENT_REGISTRY_PROVIDER as ɵd, MDC_EVENT_REGISTRY_PROVIDER_FACTORY as ɵc };
